...
import com.bidease.org.prebid.mobile.reflection.sdk.UserConsentManagerReflection;
...
import com.bidease.org.prebid.mobile.testutils.BaseSetup;
...
public class TargetingParamsTest extends BaseSetup {
    ...
    public void testBundleName() throws Exception {
        ...
        assertEquals("com.bidease.org.prebid.mobile.core.test", TargetingParams.getBundleName());
        TargetingParams.setBundleName("com.bidease.org.prebid.mobile");
        assertEquals("com.bidease.org.prebid.mobile", TargetingParams.getBundleName());
    }
