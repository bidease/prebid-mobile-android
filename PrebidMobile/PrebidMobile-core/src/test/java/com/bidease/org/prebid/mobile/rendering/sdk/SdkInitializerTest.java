...
import com.bidease.org.prebid.mobile.Host;
...
import com.bidease.org.prebid.mobile.reflection.sdk.PrebidMobileReflection;
import com.bidease.org.prebid.mobile.rendering.listeners.SdkInitializationListener;
...
public class SdkInitializerTest {
    ...
    public void runBackgroundTasks_checkStartedTasks() throws InterruptedException {
        ...
        MatcherAssert.assertThat(requesterClassName, is(startsWith("class com.bidease.org.prebid.mobile.rendering.sdk.StatusRequester")));
        ...
        MatcherAssert.assertThat(firstTaskName, is(startsWith("class com.bidease.org.prebid.mobile.rendering.sdk.SdkInitializer$UserConsentFetcherTask")));

        String secondTaskName = allTasks.get(1).getClass().toString();
        MatcherAssert.assertThat(secondTaskName, is(startsWith("class com.bidease.org.prebid.mobile.rendering.sdk.UserAgentFetcherTask")));
