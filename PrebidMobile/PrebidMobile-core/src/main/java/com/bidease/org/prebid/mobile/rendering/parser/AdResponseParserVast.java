...
package com.bidease.org.prebid.mobile.rendering.parser;
...
import com.bidease.org.prebid.mobile.rendering.errors.VastParseError;
import com.bidease.org.prebid.mobile.rendering.networking.parameters.BasicParameterBuilder;
import com.bidease.org.prebid.mobile.rendering.utils.helpers.Utils;
import com.bidease.org.prebid.mobile.rendering.video.VideoAdEvent;
import com.bidease.org.prebid.mobile.rendering.video.vast.*;
...
public class AdResponseParserVast extends AdResponseParserBase {
    ...
    private ArrayList<com.bidease.org.prebid.mobile.rendering.video.vast.Tracking> trackings;
    private ArrayList<ClickTracking> clickTrackings;
    private ArrayList<Impression> impressions;

    private VAST vast;

    public ArrayList<com.bidease.org.prebid.mobile.rendering.video.vast.Tracking> getTrackings() {
        return trackings;
    }
    ...
    public ArrayList<com.bidease.org.prebid.mobile.rendering.video.vast.Tracking> getTrackingEvents(VAST vast, int index) {
    ...
    public ArrayList<com.bidease.org.prebid.mobile.rendering.video.vast.Tracking> getAllTrackings(AdResponseParserVast parserVast, int index) {
    ...
    public ArrayList<String> getTrackingByType(VideoAdEvent.Event event) {
        Iterator<com.bidease.org.prebid.mobile.rendering.video.vast.Tracking> iterator = trackings.iterator();

        ArrayList<String> urls = new ArrayList<>();

        while (iterator.hasNext()) {
            com.bidease.org.prebid.mobile.rendering.video.vast.Tracking t = iterator.next();
     ...
     */
    public static com.bidease.org.prebid.mobile.rendering.video.vast.Tracking findTracking(ArrayList<com.bidease.org.prebid.mobile.rendering.video.vast.Tracking> trackingEvents) {
        if (trackingEvents == null) {
            return null;
        }

        for (com.bidease.org.prebid.mobile.rendering.video.vast.Tracking tracking : trackingEvents) {
