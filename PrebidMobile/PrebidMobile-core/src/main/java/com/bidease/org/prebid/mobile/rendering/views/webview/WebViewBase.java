...
import static com.bidease.org.prebid.mobile.rendering.views.webview.AdWebViewClient.AdAssetsLoadedListener;
...
public class WebViewBase extends AdWebView implements AdAssetsLoadedListener {
    ...
    private String createAdHTML(String originalHtml) {
        boolean validHtml = originalHtml.trim().startsWith("<!DOCTYPE")
                || originalHtml.trim().startsWith("<html");
        if (!validHtml) {
