...
import static com.bidease.org.prebid.mobile.PrebidMobile.SDK_VERSION;
...
import com.bidease.org.prebid.mobile.BannerParameters;
...
public class BasicParameterBuilder extends ParameterBuilder {
    ...
    private void configureBidRequest(BidRequest bidRequest, String uuid) {
        ...
        for (Map.Entry<String, String> entry : adConfiguration.getRootExt().entrySet()) {
            bidRequest.getExt().put(entry.getKey(), entry.getValue());
        }
