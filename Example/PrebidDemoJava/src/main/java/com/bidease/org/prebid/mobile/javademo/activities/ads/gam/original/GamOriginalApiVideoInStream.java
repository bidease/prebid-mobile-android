...
import com.bidease.org.prebid.mobile.InStreamVideoAdUnit;
import com.bidease.org.prebid.mobile.PrebidMobile;
import com.bidease.org.prebid.mobile.Signals;
import com.bidease.org.prebid.mobile.Util;
...
public class GamOriginalApiVideoInStream extends BaseAdActivity {
    ...
    private void createAd() {
        ...
        adUnit.fetchDemand((resultCode, keysMap) -> {
            HashSet<com.bidease.org.prebid.mobile.AdSize> sizes = new HashSet<>();
            sizes.add(new com.bidease.org.prebid.mobile.AdSize(640, 480));
